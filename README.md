...
-----------------------------------------------------------------------
| Santiago Meynet     | Backend   | US 1 (Importar CSV/XML)           |
| Franco Romero       | Backend   | US 2 (Actualizar Productos)       |
| Leandro Delgado     | Backend   | US 3 (Cargar Imágenes)            |
| Victoria Peretti    | Frontend  | US 4 (Front-Panel Administrador)  |
-----------------------------------------------------------------------
